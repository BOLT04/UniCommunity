...
class GetMultipleBlackBoardsLink (href: String)
    : NavLink<CollectionJson>(Rels.GET_MULTIPLE_BLACKBOARDS, href, CollectionJson::class.java)

class GetSingleBlackBoardLink (href: String)
    : NavLink<BlackBoardInputDto>(Rels.GET_SINGLE_BLACKBOARD, href, BlackBoardInputDto::class.java)

class CreateBlackBoardLink (href: String)
    : BodyNavLink<BlackBoardOutputDto, BlackBoardInputDto>(
